class Primate extends Mamifero {
    ...
    public Primate(String nombreCientifico, String habitat, double esperanza, int pelaje, int crias, 
                   double peso, int gestacion, boolean extincion, int dieta, String especie, 
                   int recinto, int tamanio, int estructura, int inteligencia, double cerebro) {
